...
func (m *MockOfficeRepository) AddOffice(number, floor, branchID int64) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddOffice", number, floor, branchID)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockOfficeRepositoryMockRecorder) AddOffice(number, floor, branchID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddOffice", reflect.TypeOf((*MockOfficeRepository)(nil).AddOffice), number, floor, branchID)
}

// EditOffice mocks base method.
func (m *MockOfficeRepository) EditOffice(id, number, floor, branchID int64) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EditOffice", id, number, floor, branchID)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockOfficeRepositoryMockRecorder) EditOffice(id, number, floor, branchID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditOffice", reflect.TypeOf((*MockOfficeRepository)(nil).EditOffice), id, number, floor, branchID)
}
